  ...
  return (
    <>
      {icon ? (
        <div>
          {icon === "clearsky_day" && (
            <img className="w-16 h-16" src={Sun} alt="hej" />
          )}
          {icon === "partlycloudy_night" && (
            <img className="w-16 h-16" src={Mooncloud} alt="hej" />
          )}
          {icon === "rainshowers_day" && (
            <img className="w-16 h-16" src={RainShowerDay} alt="hej" />
          )}
          {icon === "lightrainshowers_night" && (
            <img className="w-16 h-16" src={LightRainShowersNight} alt="hej" />
          )}
          {icon === "clearsky_night" && (
            <img className="w-16 h-16" src={Halfmoon} alt="hej" />
          )}
          {icon === "partlycloudy_day" && (
            <img className="w-16 h-16" src={Smallsuncloud} alt="hej" />
          )}
          {icon === "fair_day" && (
            <img className="w-16 h-16" src={Bigsuncloud} alt="hej" />
          )}
          {icon === "lightrainandthunder" && (
            <img className="w-16 h-16" src={Lightrainandthunder} alt="hej" />
          )}
          {icon === "cloudy" && (
            <img className="w-16 h-16" src={Lightcloud} alt="hej" />
          )}
          {icon === "fair_night" && (
            <img className="w-16 h-16" src={Bigmooncloud} alt="hej" />
          )}
          {icon === "heavyrain" && (
            <img className="w-16 h-16" src={Rain} alt="hej" />
          )}
          {icon === "rain" && (
            <img className="w-16 h-16" src={Littlerain} alt="hej" />
          )}
          {icon === "lightrain" && (
            <img className="w-16 h-16" src={Smallrain} alt="hej" />
          )}
          {icon === "rainandthunder" && (
            <img className="w-16 h-16" src={Rainandthunder} alt="hej" />
          )}
          {icon === "heavyrainandthunder" && (
            <img className="w-16 h-16" src={Heavyrainandthunder} alt="hej" />
          )}
          {icon === "heavyrainshowersandthunder_day" && (
            <img className="w-16 h-16" src={Sunthunderrain} alt="hej" />
          )}
          {icon === "rainshowers_night" && (
            <img className="w-16 h-16" src={Moonrain} alt="hej" />
          )}
          {icon === "lightrainshowers_day" && (
            <img className="w-16 h-16" src={Sunrain} alt="hej" />
          )}
          {icon === "fog" && <img className="w-16 h-16" src={Fog} alt="hej" />}
        </div>
      ) : (
