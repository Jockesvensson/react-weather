...
import { sunriseSunsetShorterFunction } from "../helper/sunriseSunsetFunctions";

const SingleOneWeekWeatherShorterSunriseSundown = ({
  sunriseData,
  sunsetData,
  setSunDate,
  ...
  useEffect(() => {
    sunriseSunsetShorterFunction(currentWeatherInformationShorter, setSunDate);
  }, [currentWeatherInformationShorter, setSunDate]);
...
export default SingleOneWeekWeatherShorterSunriseSundown;
