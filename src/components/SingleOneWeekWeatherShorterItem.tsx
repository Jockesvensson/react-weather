...
import SingleOneWeekWeatherShorterRain from "./SingleOneWeekWeatherShorterRain";
import { otherWeatherDetailsFunction } from "../helper/weatherDetailsFunctions";

const SingleOneWeekWeatherShorterItem = ({ item }) => {
  ...
  return (
    <>
      ...
      <div className="singleoneweek-item-forecast">
        ...
        <SingleOneWeekWeatherShorterRain item={item} />
...
export default SingleOneWeekWeatherShorterItem;
